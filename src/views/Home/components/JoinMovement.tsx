...
const { chains, publicClient, webSocketPublicClient } = configureChains(
  ...
  [
    alchemyProvider({
      apiKey:
        "https://eth-mainnet.g.alchemy.com/v2/1Ot9sqVO7s3JSmdWAUAHe8JGlGdVEGWF",
    }),
    publicProvider(),
  ]
);
      ...
      <main className="font-text text-lg">
        <div className="text-center mt-8">
          ...
          <p className="font-text text-lg">
            ...
            {address && (
              ...
              >
                <p className="font-text text-lg" style={{ color: "black" }}>
                  {"connected " +
        ...
        <div className="mvtContainer">
          <img
            ...
            alt="Mint"
            className="mobile-full-width mvtImg"
          />
          <div className="flex flex-col md:flex-row justify-center items-center mt-8 content">
            <div className="mr-3">
              <h2 className="font-title text-3xl mb-4">FIRST...</h2>
              <a
            ...
            <div className="mt-3">
              ...
              <a
                className="relative mx-2 my-4 md:my-0 w-full md:w-1/3 text-center"
                onClick={() => {
                  isMobile ? actions() : metamaskAction();
                }}
              >
                <img
